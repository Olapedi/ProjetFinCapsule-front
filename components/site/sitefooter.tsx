...
const navigation = {
    ...
    company: [
      { name: 'Kovalys Connect', href: '#' },
      { name: 'Kovalys University', href: '#' },
    ],

    legal: [
      { name: 'Mentions légales', href: '#' },
      { name: 'Confidentialités', href: '#' },
    ],
        ...
        <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
              ...
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 className="text-sm font-semibold leading-6 text-gray-900">Société</h3>
                  <ul role="list" className="mt-6 space-y-4">
                ...
                <div className="mt-10 md:mt-0">
                  <h3 className="text-sm font-semibold leading-6 text-gray-900">Légales</h3>
                  <ul role="list" className="mt-6 space-y-4">
          ...
          <div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between bg-gray-50">
            <div>
              ...
              <p className="mt-2 text-sm leading-6 text-gray-600">
                Recevez une pépite chaque semaine pour booster vos affaires.
              </p>
            </div>
